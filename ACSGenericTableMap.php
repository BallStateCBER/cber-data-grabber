...
class ACSGenericTableMap{
	...
	#$GROUPS is an array of GroupName => comma delimited list of column names in group, defined in each specific ACS Map
	...
	/**
	 * returns an array containing all individual ACS Column Codes in the table whose English names contain the specified searchString
	 *
