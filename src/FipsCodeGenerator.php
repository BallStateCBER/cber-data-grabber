...
/**
 * Mostly unfinished class, intended to make extension of these utilities beyond Indiana easy, if we ever pursue
 * additional states
...
class FipsCodeGenerator
{
     ...
     * stateId => highest FIPS suffix; fill out as needed
     */
    private static $highestFipsByStateCode = ['18' => 183];
